                        ...
                        <div className="pl-11 space-y-4 text-gray-600 leading-relaxed">
                            <ul className="space-y-3">
                                <li className="flex items-start gap-3">
                                    ...
                                    <span>All concerns acknowledged within <strong>48 hours</strong></span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <span className="w-2 h-2 rounded-full bg-green-500 mt-2 flex-shrink-0" />
                                    <span>Verified cases resolved within <strong>5-7 business days</strong> as per applicable regulations</span>
                                </li>
                            </ul>
                        </div>
                    </section>
